<template>
  <div class="success">
    ...
    <div class="container" v-if="booking">
      ...
      <p class="thank-you text-red">Бронювання створено, але ще не оплачено</p>
      <div class="booking-info">
        ...
        <p>
          Якщо у вас є будь-які питання, будь ласка, зв'яжіться з нами за
...
const bookingId = computed(() => {
  return route.query.booking_id;
});

const fetchPayment = async () => {
  isLoading.value = true;
  try {
    const response = await $api.get(`/bookings?id=${bookingId.value}`);
